...
//   if (item.isDemolition && item.rfcShippedDate) return 'RFRC Sent'; //D03

//   if (item.isDemolition && item.rfrcActualDate) return 'DCC Accepted'; //D02

//   if (item.isDemolition && item.rfrcActualDate) return 'DCC Sent'; //D01
