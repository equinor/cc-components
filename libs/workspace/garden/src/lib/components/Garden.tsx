import { Icon, useEds } from '@equinor/eds-core-react';
import { MutableRefObject, ReactElement, Suspense, useEffect, useRef, useState } from 'react';
import {
  CustomVirtualViews,
  GardenGroup,
  GardenHeaderGroup,
...
export function Garden<TData extends Record<PropertyKey, unknown>, TContext = undefined>({
  ...
  selected = null,
  refState,
}: GardenProps<TData, TContext>): ReactElement | null {
