...
type PackageContainerProps<TData extends Record<PropertyKey, unknown>, TContext = undefined> = {
  ...
  packageChild?: React.MemoExoticComponent<(args: CustomItemView<TData>) => ReactElement>;
  customSubGroup?: React.MemoExoticComponent<(args: CustomGroupView<TData>) => ReactElement>;
  itemWidth?: number;
