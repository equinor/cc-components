...
import { RFOCTab } from './RFOCTab';
import React from 'react';

type TransferSidesheetProps = {
  id: string;
  item?: HandoverPackage;
  close: VoidFunction;
};

export const TransferSidesheet = ({ id, close: closeSidesheet, item }: TransferSidesheetProps) => {
...
const HandoverSidesheetComponent = (props: Required<TransferSidesheetProps>) => {
